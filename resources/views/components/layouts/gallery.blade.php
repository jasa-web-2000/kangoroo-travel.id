<div class="py-24 __container">
    ...
    <div
        ...
        <div class="sm:!col-span-8">
            <img loading="lazy" width="100" height="100" src="{{ asset('img/gallery/image1.jpg') }}" alt="galeri 1">
        </div>
        <div class="sm:!col-span-4">
            <img loading="lazy" width="100" height="100" src="{{ asset('img/gallery/image2.jpg') }}"
                alt="galeri 2">
        </div>
        <div class="sm:!col-span-6">
            <img loading="lazy" width="100" height="100" src="{{ asset('img/gallery/image5.jpg') }}"
                alt="galeri 5">
        </div>
        <div class="sm:!col-span-6">
            <img loading="lazy" width="100" height="100" src="{{ asset('img/gallery/image6.jpg') }}"
                alt="galeri 6">
        </div>
        <div class="sm:!col-span-4">
            <img loading="lazy" width="100" height="100" src="{{ asset('img/gallery/image3.jpg') }}"
                alt="galeri 3">
        </div>
        <div class="sm:!col-span-8">
            <img loading="lazy" width="100" height="100" src="{{ asset('img/gallery/image4.jpg') }}"
                alt="galeri 4">
        </div>
    </div>
</div>
